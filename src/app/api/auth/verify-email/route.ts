...
function resultPage(title: string, message: string, ok: boolean): Response {
  ...
  return new Response(
    ...
    <html lang="en">
      ...
      <body style="margin:0;font-family:Arial,sans-serif;background:#f1f5f9;display:flex;align-items:center;justify-content:center;min-height:100vh;">
        <div style="background:#fff;padding:40px;border-radius:16px;box-shadow:0 10px 30px rgba(0,0,0,.08);max-width:420px;text-align:center;margin:20px;">
          ...
          <a href="/login" style="display:inline-block;background:#0f172a;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:bold;font-size:14px;">Go to Sign In</a>
        </div>
      </body>
    </html>`,
